    ...
    <div className="min-h-screen bg-gray-100 p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg shadow-sm p-4">
          ...
          <p
            className={`mt-2 text-sm font-medium ${
              cambioTotalComprado < 0 ? "text-red-500" : "text-green-500"
            }`}
          >
        ...
        <div className="bg-white rounded-lg shadow-sm p-4">
          ...
          <p
            className={`mt-2 text-sm font-medium ${
              cambioTotalGastos < 0 ? "text-red-500" : "text-green-500"
            }`}
          >
            {cambioTotalGastos < 0
              ? `${cambioTotalGastos}%`
        ...
        <div className="bg-white rounded-lg shadow-sm p-4">
          ...
          <p
            className={`mt-2 text-sm font-medium ${
              cambioNuevoGasto < 0 ? "text-red-500" : "text-green-500"
            }`}
          >
            {cambioNuevoGasto < 0
              ? `${cambioNuevoGasto}%`
        ...
        <div className="bg-white rounded-lg shadow-sm p-4">
          ...
          <p
            className={`mt-2 text-sm font-medium ${
              cambioMargenGasto < 0 ? "text-red-500" : "text-green-500"
            }`}
          >
            {cambioMargenGasto < 0
              ? `${cambioMargenGasto}%`
